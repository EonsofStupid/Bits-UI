...
export type TimeFieldRootPropsWithoutHTML<T extends TimeValue = Time> =
	WithChildren<{
		/**
...
export type TimeFieldRootProps<T extends TimeValue = Time> =
	TimeFieldRootPropsWithoutHTML<T>;
