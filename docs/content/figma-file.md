...
<AspectRatio.Root ratio={16 / 9} class="w-full mt-4 ">
  ...
  <iframe title="Figma page for bits-ui" src="https://embed.figma.com/file/1430229712135910564/hf_embed?community_viewer=true&embed_host=shadcn&hub_file_id=1430229712135910564&kind=&viewer=1" class="h-full w-full overflow-hidden rounded-lg border bg-muted"></iframe>
</AspectRatio.Root>
