...
export const trigger =
	defineComponentApiSchema<ContextMenuTriggerPropsWithoutHTML>({
		title: "Trigger",
		description:
...
export const content =
	defineComponentApiSchema<ContextMenuContentPropsWithoutHTML>({
		title: "Content",
...
export const contentStatic =
	defineComponentApiSchema<ContextMenuContentStaticPropsWithoutHTML>({
		title: "ContentStatic",
		description:
...
export const separator =
	defineComponentApiSchema<ContextMenuSeparatorPropsWithoutHTML>({
		title: "Separator",
...
export const checkboxItem =
	defineComponentApiSchema<ContextMenuCheckboxItemPropsWithoutHTML>({
		title: "CheckboxItem",
		description:
...
export const checkboxGroup =
	defineComponentApiSchema<ContextMenuCheckboxGroupPropsWithoutHTML>({
		title: "CheckboxGroup",
		description:
...
export const radioGroup =
	defineComponentApiSchema<ContextMenuRadioGroupPropsWithoutHTML>({
		title: "RadioGroup",
		description:
...
export const radioItem =
	defineComponentApiSchema<ContextMenuRadioItemPropsWithoutHTML>({
		title: "RadioItem",
		description:
...
export const subTrigger =
	defineComponentApiSchema<ContextMenuSubTriggerPropsWithoutHTML>({
		title: "SubTrigger",
		description:
...
export const subContent =
	defineComponentApiSchema<ContextMenuSubContentPropsWithoutHTML>({
		title: "SubContent",
		description:
...
export const groupHeading =
	defineComponentApiSchema<ContextMenuGroupHeadingPropsWithoutHTML>({
		title: "GroupHeading",
		description:
