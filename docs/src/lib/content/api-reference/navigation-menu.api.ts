...
export const root =
	defineComponentApiSchema<NavigationMenuRootPropsWithoutHTML>({
		title: "Root",
		description:
...
export const list =
	defineComponentApiSchema<NavigationMenuListPropsWithoutHTML>({
		title: "List",
...
export const item =
	defineComponentApiSchema<NavigationMenuItemPropsWithoutHTML>({
		title: "Item",
...
export const trigger =
	defineComponentApiSchema<NavigationMenuTriggerPropsWithoutHTML>({
		title: "Trigger",
...
export const content =
	defineComponentApiSchema<NavigationMenuContentPropsWithoutHTML>({
		title: "Content",
...
export const link =
	defineComponentApiSchema<NavigationMenuLinkPropsWithoutHTML>({
		title: "Link",
...
export const indicator =
	defineComponentApiSchema<NavigationMenuIndicatorPropsWithoutHTML>({
		title: "Indicator",
		description:
...
export const viewport =
	defineComponentApiSchema<NavigationMenuViewportPropsWithoutHTML>({
		title: "Viewport",
		description:
