...
export const contentStatic =
	defineComponentApiSchema<MenubarContentStaticPropsWithoutHTML>({
		title: "ContentStatic",
		description:
...
export const separator =
	defineComponentApiSchema<MenubarSeparatorPropsWithoutHTML>({
		title: "Separator",
...
export const checkboxItem =
	defineComponentApiSchema<MenubarCheckboxItemPropsWithoutHTML>({
		title: "CheckboxItem",
		description:
...
export const checkboxGroup =
	defineComponentApiSchema<MenubarCheckboxGroupPropsWithoutHTML>({
		title: "CheckboxGroup",
		description:
...
export const radioGroup =
	defineComponentApiSchema<MenubarRadioGroupPropsWithoutHTML>({
		title: "RadioGroup",
		description:
...
export const radioItem =
	defineComponentApiSchema<MenubarRadioItemPropsWithoutHTML>({
		title: "RadioItem",
		description:
...
export const subTrigger =
	defineComponentApiSchema<MenubarSubTriggerPropsWithoutHTML>({
		title: "SubTrigger",
		description:
...
export const subContent =
	defineComponentApiSchema<MenubarSubContentPropsWithoutHTML>({
		title: "SubContent",
		description:
...
export const subContentStatic =
	defineComponentApiSchema<MenubarSubContentStaticPropsWithoutHTML>({
...
export const groupHeading =
	defineComponentApiSchema<MenubarGroupHeadingPropsWithoutHTML>({
		title: "GroupHeading",
		description:
