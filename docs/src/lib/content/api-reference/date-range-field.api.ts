...
export const root =
	defineComponentApiSchema<DateRangeFieldRootPropsWithoutHTML>({
		title: "Root",
...
export const input =
	defineComponentApiSchema<DateRangeFieldInputPropsWithoutHTML>({
		title: "Input",
...
export const segment =
	defineComponentApiSchema<DateRangeFieldSegmentPropsWithoutHTML>({
		title: "Segment",
...
export const label =
	defineComponentApiSchema<DateRangeFieldLabelPropsWithoutHTML>({
		title: "Label",
