...
export const trigger =
	defineComponentApiSchema<DropdownMenuTriggerPropsWithoutHTML>({
		title: "Trigger",
...
export const content =
	defineComponentApiSchema<DropdownMenuContentPropsWithoutHTML>({
		title: "Content",
...
export const contentStatic =
	defineComponentApiSchema<DropdownMenuContentStaticPropsWithoutHTML>({
		title: "ContentStatic",
		description:
...
export const separator =
	defineComponentApiSchema<DropdownMenuSeparatorPropsWithoutHTML>({
		title: "Separator",
...
export const arrow =
	defineComponentApiSchema<DropdownMenuArrowPropsWithoutHTML>({
		title: "Arrow",
		description:
...
export const checkboxGroup =
	defineComponentApiSchema<DropdownMenuCheckboxGroupPropsWithoutHTML>({
		title: "CheckboxGroup",
		description:
...
export const checkboxItem =
	defineComponentApiSchema<DropdownMenuCheckboxItemPropsWithoutHTML>({
		title: "CheckboxItem",
		description:
...
export const radioGroup =
	defineComponentApiSchema<DropdownMenuRadioGroupPropsWithoutHTML>({
		title: "RadioGroup",
		description:
...
export const radioItem =
	defineComponentApiSchema<DropdownMenuRadioItemPropsWithoutHTML>({
		title: "RadioItem",
		description:
...
export const subTrigger =
	defineComponentApiSchema<DropdownMenuSubTriggerPropsWithoutHTML>({
		title: "SubTrigger",
		description:
...
export const subContent =
	defineComponentApiSchema<DropdownMenuSubContentPropsWithoutHTML>({
		title: "SubContent",
		description:
...
export const group =
	defineComponentApiSchema<DropdownMenuGroupPropsWithoutHTML>({
		title: "Group",
		description:
...
export const groupHeading =
	defineComponentApiSchema<DropdownMenuGroupHeadingPropsWithoutHTML>({
		title: "GroupHeading",
		description:
