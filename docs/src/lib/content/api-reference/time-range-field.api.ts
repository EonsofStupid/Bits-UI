...
import {
	...
	root as timeFieldRoot,
} from "./time-field.api.js";
import {
...
export const root =
	defineComponentApiSchema<TimeRangeFieldRootPropsWithoutHTML>({
		title: "Root",
		...
		props: {
			value: defineComponentPropSchema({
				...
				stringDefinition:
					"{ start: TimeValue | undefined; end: TimeValue | undefined }",
...
export const input =
	defineComponentApiSchema<TimeRangeFieldInputPropsWithoutHTML>({
		title: "Input",
...
export const segment =
	defineComponentApiSchema<TimeRangeFieldSegmentPropsWithoutHTML>({
		title: "Segment",
...
export const label =
	defineComponentApiSchema<TimeRangeFieldLabelPropsWithoutHTML>({
		title: "Label",
