...
<svelte:head>
        <title>ColdLight UI – Headless component primitives for Svelte</title>
        <meta
                name="description"
                content="Headless component primitives for Svelte — clean, foundational, and precisely crafted by ColdLight Design Studio."
        />
</svelte:head>
...
<div class="border-b border-solid border-black/10 bg-white dark:border-white/20 dark:bg-[#171717]">
        <header class="flex items-center justify-between px-3 py-[17px] lg:grid lg:grid-cols-3 lg:px-5">
                ...
                <nav class="mt-2 flex items-center text-center lg:block">
                        <ul>
                                ...
                                <li class="inline-block">
                                        <a
                                                href="https://github.com/coldlight-design/coldlight-ui"
                                                target="_blank"
                                                class="data-active:text-foreground data-active:bg-black/5 dark:data-active:bg-white/10 dark:data-active:text-white/100 rounded-[40px] px-[0.9em] pb-[0.4em] pt-[0.3em] text-sm font-medium leading-none tracking-[0.01em] transition hover:bg-black/5 dark:text-white/50 dark:hover:bg-white/10"
                                                >GitHub</a
                                        >
        ...
        >
                <div class="mx-7 text-center lg:mx-auto lg:w-7/12">
                        <a
                                href="https://github.com/coldlight-design/coldlight-ui/releases"
                                target="_blank"
                        ...
                        >
                                ...
                                <span
                                        ...
                                        >ColdLight UI — Now Available</span
                                >
                        </a>
                        <h1
                        ...
                        >
                                Headless component primitives for Svelte
                        </h1>
                        <p
                        ...
                        >
                                Clean, foundational, and precisely crafted primitives — the architecture for
                                your own design system, on your terms.
                        </p>
                        <Button.Root
...
>
        <div class="text-muted-foreground flex items-center gap-2 text-sm font-medium lg:gap-3">
                <span class="bg-foreground/20 block aspect-square h-3 w-3 rounded-full"></span>2026 ColdLight Design Studio
                team
        </div>
        <ul class="flex items-center justify-end gap-3 lg:gap-[26px]">
                <li>
                        <a
                                href="https://coldlight.design/llms.txt"
                                target="_blank"
